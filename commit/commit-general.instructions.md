...
- The headline (the first line of a commit message) should be concise and short, LESS THAN 10 WORDS. More content should be split into bullet lists in the body.
...
- Similarly, saying "something is renamed" is more accurate than "something is deleted and something else is added" when the addition and deletion happen in the same place and involve similar items with maybe relative names.
